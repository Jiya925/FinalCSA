...
public class ComputerGenBoard {
	 int[][] board;
	    ...
	    // Constructor
	    public ComputerGenBoard(int k) {
	        this.N = 9;
	        spots = k;

	        // find square root of N
	        Double SRNumd = Math.sqrt(N);
	        SRNum = SRNumd.intValue();
	    ...
	    public void fillValues() {
	        // Fill the diagonal of 3 x 3 (SRNum) boardrices
	        fillDiagonal();

	        // Fill remaining blocks
	        fillRemaining(0, SRNum);

	        // Remove random spots digits to make difficulty and game
	        removespotsDigits();
	    }

	    // Fill the 3 diagonal of 3 x 3 boardrices
	    void fillDiagonal() {
